...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.claimText.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.claimText.setStyleSheet("")
        ...
        self.figureText.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.figureText.setStyleSheet("")
        ...
        self.descriptionText.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        ...
        self.abstractText.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.abstractText.setStyleSheet("")
        ...
        self.claimCheckbox.setObjectName("claimCheckbox")
        self.horizontalLayout_4.addWidget(self.claimCheckbox)
        ...
        self.horizontalLayout_4.addWidget(self.descriptionCheckbox)
        ...
        self.resultText.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        ...
        self.pastePlainTextAction = QtWidgets.QAction(mainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/paste_text_blue.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pastePlainTextAction.setIcon(icon13)
        self.pastePlainTextAction.setObjectName("pastePlainTextAction")
        self.undoAction = QtWidgets.QAction(mainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/undo_blue.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.undoAction.setIcon(icon14)
        self.undoAction.setObjectName("undoAction")
        self.redoAction = QtWidgets.QAction(mainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/redo_blue.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.redoAction.setIcon(icon15)
        self.redoAction.setObjectName("redoAction")
        self.selectAllAction = QtWidgets.QAction(mainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/selectall_blue.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.selectAllAction.setIcon(icon16)
        ...
        self.menu_2.addAction(self.pastePlainTextAction)
        self.menu_2.addSeparator()
        self.menu_2.addAction(self.selectAllAction)
        self.menu_2.addSeparator()
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.pastePlainTextAction.setText(_translate("mainWindow", "粘贴为纯文本"))
        self.pastePlainTextAction.setShortcut(_translate("mainWindow", "Ctrl+Shift+V"))
        ...
        self.redoAction.setShortcut(_translate("mainWindow", "Ctrl+Y"))
        self.selectAllAction.setText(_translate("mainWindow", "全选"))
        self.selectAllAction.setShortcut(_translate("mainWindow", "Ctrl+A"))
